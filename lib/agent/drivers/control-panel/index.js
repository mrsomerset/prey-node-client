  ...
  this.register_device = function(cb){
    ...
    register({api_key: this.api_key}, function(err, data){
      if (err || !data.device_key)
        throw(err || new Error("Couldn't register this device. Try again in a sec."));
