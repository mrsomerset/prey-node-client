...
exports.run_via_trigger = function(){
  return !!process.env.TRIGGER;
}

exports.run_via_service = function(){
  return (process.platform == 'win32' && !process.env.HOMEPATH);
}

exports.run_via_daemon = function(){
  return exports.run_via_cron()
      || exports.run_via_trigger()
      || exports.run_via_service();
}
